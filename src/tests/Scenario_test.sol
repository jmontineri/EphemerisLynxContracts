...
contract ScenarioTest is Test {
    ...
    function addAttributeToIdOne(){
        //create the attribute
         attr1 = new Attribute("location1", "hash1", address(id1));

        //add the attribute to the ID
        idCtrl1.addAttribute("attr1", attr1);
    ...
    function addAttributeToIdTwo(){
        //create the attribute
         attr2 = new Attribute("location2", "hash2", address(id2));

        //add the attribute to the ID
        idCtrl2.addAttribute("attr2", attr2);
